...
public:
  ...
  void append_cell(const char *table, const char *field, const AggrOp aggrOp)
  {
    append_cell(TupleCellSpec(table, field, nullptr, aggrOp));
  }
  void append_cell(const char *alias, const AggrOp aggrOp)
  {
    append_cell(TupleCellSpec(alias, aggrOp));
  }
  int cell_num() const
  {
